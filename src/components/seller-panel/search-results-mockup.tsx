...
const AFTER_RESULTS: MockResult[] = [
  { rank: 1, name: "Trampki miejskie", price: 249, swatch: "#c9c2b6" },
  { rank: 2, name: "Twoje trampki lniane", price: 269, swatch: "#d8c9a8", isOwn: true },
    ...
    >
      ...
      <span className="min-w-0 flex-1">
        {sponsored && result.isOwn && (
          <span className="inline-block mb-1 text-[10px] font-medium uppercase tracking-wider bg-charcoal text-white px-2 py-0.5">
            Sponsorowane
          </span>
        )}
        <span
...
export function SearchResultsMockup() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div>
        <p className="text-label mb-3">Ze sponsorowaniem — pozycja #2</p>
        <ul className="bg-cream-light p-3 space-y-1">
